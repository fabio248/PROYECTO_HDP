...
var defaultOptions = {
   ...
   *
   * See [chunksUploaded](#primer_proyecto-chunksUploaded) for the callback to finalise an upload.
   */
  chunking: false,
   ...
   * as a primer_proyecto option, you could create a div with the id `tpl`,
