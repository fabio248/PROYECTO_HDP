...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "bins binsof bit break buf bufif0 bufif1 byte case casex casez cell chandle checker class clocking cmos primer_proyecto " +
  ...
  */
  ...
  var blockKeywords = words(
    "case checker class clocking primer_proyecto function generate interface module package " +
